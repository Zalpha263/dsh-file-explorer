...
/* ============================================================
   v1.9.2：行视图重构 —— 单行容器布局
   每逻辑行一个 flex 行（行号 span + 内容 span）：软换行由内容 span
   撑高整行，行号随行等高 —— 行号与逻辑行一一对应、不占新行号。
   ============================================================ */
.fexp-lines { display: flex; flex-direction: column; flex: 1; min-width: 0; }
.fexp-linerow { display: flex; align-items: stretch; }
.fexp-linerow .fexp-lineno { flex: none; padding-right: 10px; text-align: right; color: var(--dsw-alias-label-tertiary); user-select: none; font-size: 12px; line-height: 20px; box-sizing: border-box; }
.fexp-lines .fexp-cline { flex: 1; min-width: 0; padding-left: 8px; }
`;
