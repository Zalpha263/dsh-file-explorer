...
.fexp-toolbar { display: flex; flex-wrap: nowrap; gap: 4px; padding: 6px 8px; border-bottom: 1px solid var(--dsw-alias-border-l1, rgba(127,127,127,.22)); }
.fexp-tbtn-label { white-space: nowrap; }
...
.fexp-tree { flex: 1; overflow-y: auto; overflow-x: hidden; padding: 4px 0; min-height: 0; }
.fexp-row { display: flex; align-items: center; gap: 4px; padding: 2px 8px; cursor: pointer; white-space: nowrap; border-radius: 4px; min-width: 0; }
...
.fexp-panel.fexp-hostpanel { position: static; width: 100%; height: 100%; min-width: 0; max-width: none; border: none; border-radius: 0; box-shadow: none; background: transparent; flex: 1 1 auto; }
.fexp-panel.fexp-hostpanel .fexp-header { cursor: default; }
/* ============================================================
   v1.10.3：宿主右侧栏标签下的紧凑布局
   ------------------------------------------------------------
   面板现在渲染在官方右侧栏的 pane body 里，宽度由列几何决定
   （首开 = frame 的 45%，下限 300px），与旧的 400px 独立面板无关。
   宿主（dsh-ui-beautify v2.0.1）在面板小于 420px 时给容器加
   [data-dsh-narrow]，并在带 .fexp-panel 的元素上补 .fexp-narrow
   （由 ResizeObserver 按**面板自身**宽度驱动，不再是窗口宽度）。
   ============================================================ */
/* 工具栏：图标始终保留，标签在窄宽度下让位。不给 flex-wrap —— 换行会让
   三个按钮各占一行、把树挤到屏幕外（这正是挂到右侧栏后的原始症状）。 */
.fexp-narrow .fexp-tbtn-label, [data-dsh-narrow] .fexp-tbtn-label { display: none; }
.fexp-narrow .fexp-tbtn, [data-dsh-narrow] .fexp-tbtn { padding: 3px 7px; gap: 0; }
/* 树行：文件名截断而不是把行撑宽；行内文件大小在窄宽度下隐藏
   （.fexp-narrow .fexp-size 的规则在上面 v1.3 一节，这里补宿主标记的那一半）。 */
[data-dsh-narrow] .fexp-size { display: none; }
.fexp-narrow .fexp-header, [data-dsh-narrow] .fexp-header { padding: 6px 8px; gap: 4px; }
.fexp-narrow .fexp-searchbar, [data-dsh-narrow] .fexp-searchbar { margin: 6px 8px 2px; }
.fexp-narrow .fexp-toolbar, [data-dsh-narrow] .fexp-toolbar { padding: 5px 6px; }
/* ============================================================
...
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-number, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-symbol { color: #098658; }
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-comment, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-quote { color: #008000; font-style: italic; }
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-title, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-title.function_, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-section { color: #795e26; }
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-title.class_, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-type, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-built_in { color: #267f99; }
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-params, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-variable, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-template-variable, :where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-attr { color: #001080; }
:where(.fexp-panel, .fexp-preview-card):not([data-fexp-theme="dark"]) .hljs-deletion { color: #cd3131; }
...
/* --- hljs 配色：暗色（VS Code Dark+ 风格） --- */
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs { color: #d4d4d4; background: transparent; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-keyword, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-selector-tag, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-literal, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-meta .hljs-keyword, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-doctag, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-meta { color: #569cd6; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-string, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-regexp, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-addition, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-attribute { color: #ce9178; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-number, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-symbol { color: #b5cea8; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-comment, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-quote { color: #6a9955; font-style: italic; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-title, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-title.function_, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-section { color: #dcdcaa; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-title.class_, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-type, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-built_in { color: #4ec9b0; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-params, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-variable, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-template-variable, :where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-attr { color: #9cdcfe; }
:where(.fexp-panel, .fexp-preview-card)[data-fexp-theme="dark"] .hljs-deletion { color: #f44747; }
...
.fexp-editor-lineno { position: sticky; left: 0; z-index: 2; flex: none; width: var(--fexp-noW, 44px); box-sizing: border-box; padding-right: 8px; text-align: right; color: var(--dsw-alias-label-tertiary); user-select: none; background: var(--dsw-alias-bg-layer-2); white-space: nowrap; font-family: ui-monospace, 'SF Mono', SFMono-Regular, Menlo, Consolas, 'Cascadia Code', monospace; font-size: 13px; }
...
`;
		...
		const ICON_PATHS = {
			...
			undo: '<path d="M9 14L4 9l5-5"/><path d="M4 9h9a7 7 0 0 1 7 7v1"/>',
			redo: '<path d="M15 14l5-5-5-5"/><path d="M20 9h-9a7 7 0 0 0-7 7v1"/>',
		...
		// v1.9.17：几何升级为【宽度感知】——ASCII/等宽字符 1 列 = editCharW；
		// 中日韩/全角/emoji 等宽字符按实测 editCjkW（≈2 倍）走；Tab 仍按
		// 4 个 charW 列的网格步进（tab-size:4）。修复中文/全角行内光标错位。
		let _editCharW = 0;
		let _editCjkW = 0;
		/** 用隐藏 DOM span 按 .fexp-code-font 同款字体串测量一段文本的平均字符宽
		 *  （DOM 分辨率与实际渲染一致；canvas 的 ctx.font 解析字体栈可能不一致）。 */
		function _editMeasure(text) {
			const el = document.createElement("span");
			el.style.cssText = "position:absolute;left:-9999px;top:0;visibility:hidden;white-space:pre;font-family:ui-monospace,'SF Mono',SFMono-Regular,Menlo,Consolas,'Cascadia Code',monospace;font-size:13px;";
			el.textContent = text;
			document.body.appendChild(el);
			const w = el.getBoundingClientRect().width / text.length;
			el.remove();
			return w;
		}
		/** ASCII/等宽字符宽度（px）：62 个字母数字实测一次并缓存。 */
		function editCharW() {
			if (_editCharW > 0) return _editCharW;
			try {
				_editCharW = _editMeasure("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
			} catch (err) { /* 回退到保守值 */ }
			if (!(_editCharW > 0)) _editCharW = 7.8;
			return _editCharW;
		}
		/** 中日韩等宽字符宽度（px）：全角样本实测一次并缓存（≈ 2 × charW）。 */
		function editCjkW() {
			if (_editCjkW > 0) return _editCjkW;
			try {
				_editCjkW = _editMeasure("常见问题排查表中文测试事项说明");
			} catch (err) { /* 回退到保守值 */ }
			if (!(_editCjkW > 0)) _editCjkW = 2 * editCharW();
			return _editCjkW;
		}
		/** 该码元是否为宽字符（EAW W/F 常用集）：中文/全角/假名/谚文/emoji 等。 */
		function edIsWideCode(c) {
		...
		/** 列 → x（px）。宽字符 +cjkW；Tab 按 4 个 charW 列网格步进（tab-size:4）。
		 *  col 以【码元】计（JS 索引），与 edIdxToLineCol 的 col 语义一致。 */
		function edColToX(text, col, chW, cjkW) {
			let x = 0;
			const n = col < text.length ? col : text.length;
			for (let i = 0; i < n; i += 1) {
				const c = text.charCodeAt(i);
				if (c === 9) {
					const k = Math.floor(x / chW);
					x = (k + (4 - (k % 4))) * chW;
				} else if (c >= 0xD800 && c <= 0xDBFF) {
					i += 1; // 代理对 = 一个宽字符（emoji 等）
					x += cjkW;
				} else if (edIsWideCode(c)) {
					x += cjkW;
				} else {
					x += chW;
				}
		...
		/** x → 列（每个字符按其实际宽度的中点规则；越界返回行尾）。 */
		function edXToCol(text, x, chW, cjkW) {
			let pos = 0;
			let i = 0;
			while (i < text.length) {
				const c = text.charCodeAt(i);
		...
		// ============ v1.9.18 撤回栈（VS Code 语义）——纯函数部分 ============
		// 记录结构：{ kind, oldStart, oldEnd, newStart, newEnd, textBefore,
		//            textAfter, selBefore:{a,b}, selAfter:{a,b}, anchor }。
		// oldRange = 编辑前文本中的区间（重做时替换为 textAfter）；
		// newRange = 编辑后文本中的区间（撤销时替换回 textBefore）。
		// undo stop 规则（对齐 VS Code）：连续 typing/delete（光标不动、无选区、
		// 相邻区间）合并为一步；paste/cut/drop/enter/tab/ime/其它 各自一步；
		// 不按时间分段。
		/** 计算一次编辑的变更区间（前后缀 diff，以编辑前选区为界）。无变化返回 null。
		 *  前后缀都钳制在选区范围内：否则"插入位置的相邻字符相同"（如 "abb" 中
		 *  再插 'b'、或在已有 "!!" 后再插 '!'）会被贪心 diff 吃成空/错区间。 */
		function edDiffEdit(oldText, oA, oB, newText, nA, nB) {
			if (oldText === newText) return null;
			const ol = oldText.length;
			const nl = newText.length;
			const selLo = Math.min(oA, oB);
			const selHi = Math.max(oA, oB);
			let p = 0;
			const maxP = Math.min(ol, nl, selLo);
			while (p < maxP && oldText.charCodeAt(p) === newText.charCodeAt(p)) p += 1;
			let s = 0;
			const maxS = Math.min(ol - p, nl - p, ol - selHi);
			while (s < maxS && oldText.charCodeAt(ol - 1 - s) === newText.charCodeAt(nl - 1 - s)) s += 1;
			const textBefore = oldText.slice(p, ol - s);
			const textAfter = newText.slice(p, nl - s);
			if (textBefore === textAfter) return null;
			return {
				oldStart: p, oldEnd: ol - s,
				newStart: p, newEnd: nl - s,
				textBefore, textAfter,
				selBefore: { a: oA, b: oB }, selAfter: { a: nA, b: nB }, anchor: nA
			};
		}
		/** 判断 cur 能否与 prev 合并为一步（undo stop 判定）。
		 *  锚点 anchor = 上一笔编辑后的光标位置（新文本坐标系）。
		 *  删除链以"上一笔的新文本"为参照：Backspace 链 = cur 旧区间终点 =
		 *  prev 新区间起点（光标前一个字符）；Del 链 = cur 旧区间起点 = prev. */
		function edCanMergeUndo(prev, cur) {
			if (prev.kind !== cur.kind) return false;
			if (cur.kind !== "typing" && cur.kind !== "delete") return false;
			// 本次编辑必须从上一笔的锚点（单点光标、无选区）开始
			if (cur.selBefore.a !== prev.anchor || cur.selBefore.b !== prev.anchor) return false;
			if (cur.kind === "typing") return true; // 连续输入同一锚点 = 同一 burst
			if (cur.oldEnd === prev.newStart) return true; // Backspace 链
			if (cur.oldStart === prev.newStart) return true; // Del 链
			return false;
		}
		/** 合并相邻两笔为一步（仅限可合并情形，调用方先用 edCanMergeUndo 判定）。 */
		function edMergeEdit(prev, cur) {
			let rec;
			if (cur.kind === "typing") {
				// 插入顺延（含选区替换后继续输入）：旧区间取首笔、新区间到当前光标
				rec = {
					oldStart: prev.oldStart, oldEnd: prev.oldEnd,
					newStart: prev.newStart, newEnd: cur.newEnd,
					textBefore: prev.textBefore + cur.textBefore,
					textAfter: prev.textAfter + cur.textAfter
				};
			} else if (cur.oldEnd === prev.newStart) {
				// 删除前移（Backspace 链）
				rec = {
					oldStart: cur.oldStart, oldEnd: prev.oldEnd,
					newStart: cur.newStart, newEnd: cur.newEnd,
					textBefore: cur.textBefore + prev.textBefore,
					textAfter: cur.textAfter + prev.textAfter
				};
			} else {
				// 连续前向删除（Del 链）：同起点、区间扩大
				rec = {
					oldStart: prev.oldStart, oldEnd: cur.oldEnd,
					newStart: prev.newStart, newEnd: cur.newEnd,
					textBefore: prev.textBefore + cur.textBefore,
					textAfter: prev.textAfter + cur.textAfter
				};
			...
			rec.kind = prev.kind;
			rec.selBefore = prev.selBefore;
			rec.selAfter = cur.selAfter;
			rec.anchor = cur.anchor;
			return rec;
		}
		...
		function readClipboard() {
			try {
				...
				if (!raw) return null;
				const parsed = JSON.parse(raw);
				// v1.10.1: 拒绝空 path——writeClipboard 清空时若写入占位对象
				// {path:"",type:"file"}，这里会把"空剪贴板"读成非空，界面出现
				// 可点却静默无操作的「粘贴」（pasteInto 因 !clip.path 早退）。
				if (parsed && typeof parsed.path === "string" && parsed.path !== "" && (parsed.type === "file" || parsed.type === "dir")) return parsed;
				return null;
			} catch (err) { return null; }
		}
		...
		// "strict" with passthrough schemas: since DSH 0.1.7 both Gateways require a create() factory and call
		...
		async function apply(ctx) {
			...
			// v1.10.1: 更正注释——`ctx.remote.fileExplorer` 属性访问本身并不必然
			// 抛错（宿主网关自己的 30+ 处内部代码就用 `ctx.remote.settings.*` 属性
			// 访问）；本插件统一走 `ctx.get("remote.fileExplorer")` 的共享 store 直读
			// 路径并修饰为 Promise，是为了让缺失命名空间时以 reject 呈现而不是
			// 同步抛错（同步 throw 在面板构建路径上会 abdicate 槽位条目）。语义上
			// 两种写法都合法，这里是选择而非规避。
			function unwrap(result) {
				if (result && result.ok === true) return result.value;
				const error = result && result.error;
				/* v1.10.1: 诊断增强——保留网关错误码（如 gateway/cancelled 与
				   gateway/internal 的区分），仅显示 message 时二者不可辨。 */
			...
			/** v1.10.1: 重命名后重键路径（子树前缀迁移）；无关路径原样返回。 */
			function rekeyPath(key, from, to) {
				const sep = pathSep();
				const fromNorm = from.replace(/[\\/]+$/, "");
				const comparable = (s) => (state.platform === "win32" ? s.toLowerCase() : s);
				if (comparable(key) === comparable(fromNorm)) return to;
				if (comparable(key).startsWith(comparable(fromNorm) + sep)) return to + sep + key.slice(fromNorm.length + 1);
				return key;
			}
			function rekeyCache(cache, from, to) {
				if (!cache || cache.size === 0) return;
				const entries = Array.from(cache.entries()).map(([k, v]) => [rekeyPath(k, from, to), v]);
				cache.clear();
			...
			/** v1.9.21: AppFrame（三列网格帧）定位——不再依赖 css-module 哈希类
			 *  （.pI_x6G_frame 随宿主构建可变，仅当意外命中有效，不作依赖）。
			 *  改用宿主稳定契约：帧元素带 data-sidebar-collapsed / data-dragging
			 *  属性（拖拽/折叠中），常规展开态则按内联 grid-template-columns 形状
			 *  （`<n>px minmax(0, 1fr) …`，AppFrame 的 React inline style）识别。 */
			function sidebarFrame() {
				try {
					const root = document.querySelector('[data-slot="root"]');
					if (root === null) return null;
					const direct = root.querySelector("[data-sidebar-collapsed], [data-dragging]");
					if (direct && /^\d/.test(direct.style.gridTemplateColumns || "")) return direct;
					for (const el of root.querySelectorAll("[style]")) {
						const g = el.style ? el.style.gridTemplateColumns : "";
						if (g !== "" && /^\d+(?:\.\d+)?px\s+minmax/.test(g)) return el;
					}
				} catch (err) {}
				return null;
			}
			...
			function writeClipboard() {
				try {
					if (state.clipboard === null || typeof state.clipboard.path !== "string" || state.clipboard.path === "") {
						window.localStorage.removeItem(CLIPBOARD_KEY);
					} else {
						window.localStorage.setItem(CLIPBOARD_KEY, JSON.stringify(state.clipboard));
					}
				} catch (err) {}
			}
			function pathSep() {
			...
			/** v1.10.1: 平台默认值改为浏览器推断（原默认 "win32" 会让非 Windows
			 *  主机在 wsRoot 首轮响应前拼出反斜杠路径）。宿主 wsRoot 返回后以
			 *  宿主平台为准（wsRoot 成功时更新 state.platform）。 */
			...
			/* v1.9.18: 每文件撤回历史（会话内保留，跨编辑器重建/保存/切换模式）。
			   path → { base: 打开时文本, stack: [...], redo: [...] }；
			   与 base 不一致（外部修改/版本变化）时由 startEditing 丢弃重建。 */
			const EDIT_UNDO_MAX = 500; // 每文件撤回步数上限（溢出丢最旧）
			const editUndo = new Map();
			/* v1.9.16: 面板缩放 chrome（独立 overlay 层，buildPanelInto 创建/rebuild 时重挂） */
			let panelChrome = null;
			/* --- v1.6: ui-beautify card-mode host integration --- */
			const PANEL_ID = "file-explorer";
			let hostMode = false;         // ui-beautify's sidebarPanel owns the panel surface
			let hostPanelActive = false;  // refs currently point into a mounted host panel
			let hostApiRef = undefined;   // optional `sidebarPanel` service (ui-beautify)
			let hostDispose = null;       // registerPanel disposer
			let standaloneRefs = null;    // captured classic-panel node refs for re-pointing
			/* v1.7: the header entry hides itself once the host takes over —
			   listeners let the React entry re-render when the service appears/unloads. */
			...
			let lastDomPath = null;    // v1.10.1: 上一次探针得到的稳定工作区路径（瞬时空快照判决）
			...
			/* v1.10.1: 停靠面板顶部偏移不再依赖钉死常数——宿主头部布局改变时
			   自动以宿主网格首列（侧栏列）的视口 top 校准（.fexp-host 为
			   display:contents，面板绝对定位以视口为参照；实测值 40..200 内采
			   用并缓存，历史实测值 76 作为回退）。 */
			let dockTopInset = 76;
			function measuredDockTopInset() {
				try {
					const fr = sidebarFrame();
					const col = fr !== null ? fr.children[0] : null;
					if (col instanceof HTMLElement && col.isConnected) {
						const t = Math.round(col.getBoundingClientRect().top);
						if (t >= 40 && t <= 200) { dockTopInset = t; return t; }
					}
			...
			function applyDock() {
				...
				if (state.dock === "right") {
					...
					panelEl.style.top = measuredDockTopInset() + "px";
			...
			function walkTree(container, path, depth) {
				...
				/* v1.9.21: 空目录/全部隐藏时的可见空态（搜索态由 renderTree 的
				   「无匹配项」兜底，这里不打扰过滤结果） */
				if (visible.length === 0 && !state.search.active) {
					container.appendChild(rowEl("（空目录）", depth, "fexp-dim"));
					return;
				}
				for (const e of dirs) {
			...
			function ensurePreviewCard() {
				...
				/* v1.9.19: 卡片创建即打主题标记（否则卡片可能长期缺失
				   data-fexp-theme、在深色模式下落到浅色配色导致文字吃力） */
				themeNow();
				return card;
			}
			...
			function buildEditor() {
				...
				hint.textContent = "实时高亮 · Ctrl+Z 撤销 · Ctrl+S 保存 · Esc 退出 · Tab 缩进";
				const undoBtn = iconBtn("undo", "撤销", "撤销（Ctrl+Z）", () => doUndo(), "fexp-editbtn");
				const redoBtn = iconBtn("redo", "重做", "重做（Ctrl+Shift+Z）", () => doRedo(), "fexp-editbtn");
				...
				const chW = editCharW();
				const cjkW = editCjkW(); // v1.9.17: 中文/全角/emoji 宽字符宽度（≈2×chW）
				...
				// --- v1.9.18 撤回/反撤回（VS Code 语义：undo stop 分组 + 每文件历史）---
				// 历史挂在 editUndo（按路径，会话内保留）：撤销=区间回填 textBefore、
				// 重做=textAfter，并恢复各自的光标/选区；连续 typing/delete 且光标未动
				// 且区间相邻 → 合并为一步；paste/enter/tab/ime/deleteWord/其它 → 各自一步。
				// base=打开时文本（校验用）；current=栈当前状态文本（重开编辑时与文件
				// 文本比对：一致则保留历史——自己保存不丢，外部修改则丢弃）。
				let hist = editUndo.get(p.path);
				if (hist === undefined) {
					hist = { base: ed.text, current: ed.text, stack: [], redo: [] };
					editUndo.set(p.path, hist);
				}
				let pendingEdit = null; // beforeinput 快照 {value, a, b, type}
				let compBase = null;    // IME 合成开始前快照（整个中文词 = 一步）
				const updateUndoButtons = () => {
					if (undoBtnEl) undoBtnEl.disabled = hist.stack.length === 0;
					if (redoBtnEl) redoBtnEl.disabled = hist.redo.length === 0;
				};
				const applyRecord = (rec, useBefore) => {
					const v = ta.value;
					const piece = useBefore ? rec.textBefore : rec.textAfter;
					// 撤销作用于【编辑后文本】的 newRange；重做作用于【编辑前文本】的 oldRange
					const s = useBefore ? rec.newStart : rec.oldStart;
					const e = useBefore ? rec.newEnd : rec.oldEnd;
					const nv = v.slice(0, s) + piece + v.slice(e);
					ta.value = nv;
					ed.text = nv;
					hist.current = nv;
					refreshModel();
					const sel = useBefore ? rec.selBefore : rec.selAfter;
					ta.setSelectionRange(sel.a, sel.b);
					readSel();
					scheduleWindow();
					ensureCaretVisible();
				};
				const doUndo = () => {
					const rec = hist.stack.pop();
				...
				const recordEdit = (kind, before, after) => {
					const d = edDiffEdit(before.value, before.a, before.b, after.value, after.a, after.b);
					if (d === null) return;
					const rec = Object.assign({ kind: kind, ts: Date.now() }, d);
					const stack = hist.stack;
					const prev = stack[stack.length - 1];
					if (prev !== undefined && edCanMergeUndo(prev, rec)) {
						stack[stack.length - 1] = edMergeEdit(prev, rec);
					} else {
						stack.push(rec);
						if (stack.length > EDIT_UNDO_MAX) stack.shift();
					}
					hist.current = after.value;
					hist.redo = []; // 新编辑清空 redo（标准语义）
					updateUndoButtons();
				};
				/** inputType → 编辑类别（决定是否可并入上一步）。 */
				const editKindOf = (type) => {
					if (type === "insertText") return "typing";
					if (type === "insertParagraph") return "enter";
					if (type === "insertFromPaste") return "paste";
					if (type === "insertFromDrop") return "drop";
					if (type === "insertCompositionText" || type === "insertFromComposition") return "ime";
					if (type === "deleteWordBackward" || type === "deleteWordForward" ||
						type === "deleteSoftLineBackward" || type === "deleteSoftLineForward" ||
						type === "deleteHardLineForward") return "deleteWord";
					if (type === "deleteContentBackward" || type === "deleteContentForward") return "delete";
					return "other";
				};
				updateUndoButtons();
				...
				const colToX = (text, col) => edColToX(text, col, chW, cjkW);
				...
				const pointToIdx = (clientX, clientY) => {
					...
					const text = lineTextAt(line);
					const col = edXToCol(text, Math.max(0, x), chW, cjkW);
					return edLineColToIdx(lineStarts, line, col);
				};
				refreshModel();
				renderWindow();
				// --- 输入事件（model = ta.value；原生剪贴板/IME 保留，撤销/重做由本栈接管）---
				ta.addEventListener("beforeinput", (ev) => {
					// 变更前快照（Chromium 覆盖所有 value 变更路径：插入/删除/粘贴/拖放）
					pendingEdit = { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd, type: ev.inputType || "" };
				});
				ta.addEventListener("input", () => {
					refreshModel();
					if (composing) {
						// 合成期间模型已是浏览器现值（含合成中的文本），保持覆盖条；
						// 本词由 compositionend 以 compBase 整体记录（整词 = 一步）
						pendingEdit = null;
						scheduleWindow();
						return;
					}
					...
					if (pendingEdit !== null) {
						...
						pendingEdit = null;
						recordEdit(editKindOf(before.type || ""), before, { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd });
					}
					scheduleWindow();
					ensureCaretVisible();
				});
				ta.addEventListener("compositionstart", (ev) => {
					...
					compText = ev.data || "";
					compBase = { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd };
					pendingEdit = null;
					scheduleWindow();
				});
				...
				ta.addEventListener("compositionend", () => {
					...
					readSel();
					if (compBase !== null) {
						recordEdit("ime", compBase, { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd });
						compBase = null;
					}
					scheduleWindow();
					ensureCaretVisible();
				...
				const onSelChange = () => {
					// v1.9.21: 编辑器已卸载（关闭/切换文件）时移除残留的全局监听，
					// 防止每次开关编辑器在 document 上累积 selectionchange 处理器
				...
				ta.addEventListener("keydown", (ev) => {
					/* v1.9.18: 撤销/重做快捷键走本栈（preventDefault 禁用浏览器原生栈，
					   与自建历史语义保持一致） */
					const isCtrl = ev.ctrlKey || ev.metaKey;
					const k = ev.key.toLowerCase();
					if (isCtrl && k === "z" && !ev.shiftKey) {
						ev.preventDefault();
						doUndo();
						return;
					}
					if (isCtrl && (k === "y" || (k === "z" && ev.shiftKey))) {
						ev.preventDefault();
						doRedo();
						return;
					}
					if (ev.key === "Tab") {
						ev.preventDefault();
						const before = { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd };
						ta.setRangeText("  ", before.a, before.b, "end");
						refreshModel();
						readSel();
						// setRangeText 不发 beforeinput/input → 手动记录（tab = 独立一步）
						recordEdit("tab", before, { value: ta.value, a: ta.selectionStart, b: ta.selectionEnd });
						scheduleWindow();
						ensureCaretVisible();
						return;
					}
				...
				scroller.addEventListener("pointerdown", (ev) => {
					...
					document.addEventListener("pointercancel", onDragUp, { once: true });
				});
				const onDragMove = (ev) => {
				...
				const onDragUp = () => {
					...
					/* v1.10.1: pointercancel（触屏/系统中断）同样清理——原实现仅
					   pointerup 清理，拖选被系统取消时 dragAnchor 与 document
					   监听残留。 */
			...
			let saveBtnEl = null;
			let undoBtnEl = null; // v1.9.18: 撤销/重做按钮引用（编辑器重建时更新）
			let redoBtnEl = null;
			...
			function saveEdit() {
				...
				remote().fsWrite(p.path, ed.text, ed.version).then((res) => {
					// v1.10.1: 保存飞行中被关闭/切换预览时，不再用旧 p 复活预览、
					// 关掉新编辑器（对比 loadPreviewSegment 的 path 守卫）。
					if (state.preview !== p || state.editing !== ed) return;
			 ...
			 *  v1.9.18：撤回历史按路径复用——仅当历史"当前态"与文件文本一致
			 *  （自己保存=保持；外部修改=不一致）时保留，否则丢弃该文件历史。 */
			function startEditing(p) {
				...
				const h = editUndo.get(p.path);
				if (h === undefined || h.current !== p.data.text) {
					editUndo.set(p.path, { base: p.data.text, current: p.data.text, stack: [], redo: [] });
				}
			}
			/**
			...
			function openFile(entry) {
				closeEditor();
				state.preview = { path: entry.path, name: entry.name, size: entry.size, version: null, status: "loading", error: null, binary: false, mode: "edit", kind: null, language: null, data: null, loadingMore: false };
				renderPreview();
				renderTree();
				...
				remote().fsRender(path, PREVIEW_BYTES, offsetChars).then((res) => {
					...
					if (append) {
						...
						state.preview = Object.assign({}, state.preview, {
							loadingMore: false,
							// v1.10.1: 续段同样回传版本令牌——编辑保存的陈旧守卫
							// （writeText replaceIfVersion）依赖最新令牌，逐段刷新。
							version: res && typeof res.version === "string" && res.version !== "" ? res.version : state.preview.version,
					...
					state.preview = Object.assign({}, state.preview, {
						...
						error: null,
						loadingMore: false,
						// v1.10.1: 存回宿主返回的版本令牌（FsInfo.version 同族），
						// 编辑保存时作为 writeText 的 replaceIfVersion 意图——
						// 缺失会导致陈旧守卫静默失效（外部修改被覆盖）。
						version: res && typeof res.version === "string" && res.version !== "" ? res.version : null
					});
					renderPreview();
				}).catch((err) => {
					if (!state.preview || state.preview.path !== path) return;
					if (append) {
						// v1.10.1: 续读失败给出可见提示（原实现静默复位，用户
						// 点击「继续加载」无任何反馈）。
						state.preview.loadingMore = false;
						renderPreview();
						showToast("加载更多失败：" + ((err && err.message) || err));
						return;
					}
					...
					remote().fsRead(path).then((res) => {
						...
						state.preview = Object.assign({}, state.preview, {
							...
							error: null,
							loadingMore: false,
							// v1.10.1: fsRead 回退路径同样带回版本令牌（旧服务端无 version
							// 时保持 null，守卫退化为无条件写入）。
							version: res && typeof res.version === "string" && res.version !== "" ? res.version : null
						});
						renderPreview();
			...
			function makeToolbarBtn(icon, label, title, onClick) {
				...
				/* v1.10.3: 文本标签单独成类 —— 窄面板（宿主右侧栏标签）下由
				   CSS 整块隐藏，只留图标，按钮不再因为标签宽度累加而换行。 */
				lb.className = "fexp-tbtn-label";
			...
			function buildPanelInto(container, host) {
				...
				x.addEventListener("click", () => {
					if (host && hostApiRef !== undefined) {
						try { hostApiRef.closePanel(PANEL_ID); } catch (err) {}
						return;
					}
					state.open = false;
					applyOpen();
				...
				try {
					...
					for (const row of rows) {
						if (row.getAttribute("aria-expanded") !== null) {
							// workspace 组行（树序上先于其会话行者）——记录最近一个
							wsRow = row;
						} else if (row.getAttribute("aria-selected") === "true") {
							found = true;
							/* v1.9.21: 命中选中行即停。旧实现会继续扫描并把 wsRow
							   覆盖成【最后一个】展开组——多工作区时选中会话可能
							   属于更早的组，导致跟随错误的工作区。DOM 树序保证
							   选中行之前最后一个展开组就是其所属工作区。 */
							break;
						}
					}
			...
			function detectSettingsOpen() {
				...
				/* v1.10.1: 宿主若在 seat 与弹窗之间增加包装层（或弹窗嵌套在
				   更深层），直接子级扫描会漏检——设置打开时本插件浮层不被抑制
				   而盖住设置。补一次子树扫描（seat 子树很小：关闭态仅一个触发器，
				   打开态会命中上面的直接子级分支）。 */
				for (const el of seat.querySelectorAll("*")) {
					if (!(el instanceof HTMLElement)) continue;
					try {
						if (window.getComputedStyle(el).position === "fixed") return true;
					} catch (err) { /* keep scanning */ }
			...
			function toggleOpen() {
				...
				if (hostMode && d !== undefined) {
					/* OFFICIAL sidebarPanel contract (v1): isOpen() asks whether the
					   right column is EXPANDED — it carries no id. Ask whether the
					   panel actually renders at all, then close it when it does. */
					const open = typeof d.isOpen === "function" ? !!d.isOpen() : (document.querySelector(".fexp-hostpanel") !== null);
			...
			/* --- v1.6/v2.0.0: official right-Sidebar integration (ui-beautify) ---
			   The panel is a right-Sidebar TAB now: ui-beautify registers it into
			   DSH's own sidebar-right controller, which owns the tab strip, floating,
			   splitting and per-session state. */
			/** Re-evaluate host mode and keep the open state in sync between the
			 * classic standalone panel and the hosted tab. */
			function onHostChange() {
				const d = hostApiRef;
				if (d === undefined) return;
				/* v2.0.0: host mode is no longer derived from "does an app frame
				   exist" — it is exactly "did we manage to register into
				   sidebarPanel". The old probe made the classic panel step aside
				   for a host that might never render anything; now the failure
				   path (no ui-beautify, or an older one) simply keeps hostMode
				   false and the standalone panel in charge. */
				const nextHost = true;
				/* v2.0.0: open/close of the tab belongs to the right Sidebar, so
				   there is no host-side open state to mirror back. What still has
				   to be re-pointed is where our DOM lives: either inside the
				   hosted tab body or inside our own standalone panel. */
				if (nextHost === hostMode) return;
				hostMode = nextHost;
				if (hostMode) {
					/* entering host mode: the standalone panel is latent while
					   hosted — it must never re-open behind the user's back. */
					state.open = false;
				} else {
					/* leaving host mode: re-point refs in case they live in a
					   now-unmounted host tree, then re-render the standalone panel. */
			...
			/* --- v2.0.0: 绑定到 ui-beautify 的 `sidebarPanel` 服务 ---
			   规范：dsh-ui-beautify/docs/plugin-panel-integration.md（sidebarPanel API v1）。
			   v2.0.0 起 ui-beautify 不再自带「插件面板」宿主：注册进来的面板会成为
			   DSH **官方右侧栏**的一个标签页，标签条 / 浮动 / 分屏 / 每会话状态全部由
			   官方 dockkit 负责，服务名也从 `dock` 改成 `sidebarPanel`。

			   ① 首选 cordis 可选依赖 `ctx.inject(['sidebarPanel'], cb)`：服务出现时执行
			      回调（注册面板），消失（ui-beautify 热重载/卸载）时执行回调返回的清理
			      函数，再次出现时自动重新执行 —— 不需要身份比对，也不需要靠跟随循环
			      去「碰运气」重绑；
			   ② 守护 ctx（运行时动态包）没有 `inject`，退化为 internal/service 事件 +
			      1s 兜底轮询的**幂等**绑定器（用 has(id) 判断是否需要重绑）。 */
			/** Bind the panel to the sidebarPanel service (idempotent). Returns true on success. */
			function attachHost(d) {
				if (hostApiRef === d && hostDispose !== null) return true;
				if (hostApiRef !== undefined) detachHost();
				hostApiRef = d;
				try {
					hostDispose = d.registerPanel({
						id: PANEL_ID,
						title: "文件浏览器",
						icon: "📁",
						/* 右侧栏「开始」引导页上的入口胶囊。官方文件类型用 order 10，
						   这里排在它后面，两个入口都在引导页上可见。 */
						entry: { title: "文件浏览器", description: "浏览会话工作区的文件", order: 20 },
						mount: mountDockHost
					});
				} catch (err) {
					console.error("[dsh-file-explorer] sidebarPanel registration failed:", err);
					hostDispose = null;
					hostApiRef = undefined;
					return false;
				}
				/* v2.0.0: no subscribe() — the old dock service exposed an engine
				   subscription to mirror the host's open state onto our header
				   button. The right Sidebar has no equivalent, and it does not need
				   one: the host's own tab strip and guide page ARE the entry, so the
				   header button stays hidden for the whole time we are registered. */
				onHostChange();
				bumpEntryListeners();
				return true;
			}
			/** Release the host binding and hand the surface back to the standalone
			 *  panel (mirrors onHostChange's "leaving host mode" branch). */
			function detachHost() {
				if (hostApiRef === undefined) return;
				if (hostDispose !== null) { try { hostDispose(); } catch (err) {} hostDispose = null; }
				hostApiRef = undefined;
				hostMode = false;
				hostPanelActive = false;
				if (panelEl && panelEl.classList.contains("fexp-hostpanel")) restoreStandaloneRefs();
				if (panelEl) { applyDock(); renderTree(); renderPreview(); }
				state.open = false;
				applyOpen();
				bumpEntryListeners();
			}
			/** Fallback binder for guarded contexts that expose no ctx.inject. */
			function bindSidebarPanelFallback() {
				let timer = null;
				let off = null;
				const sync = function () {
					const d = ctx.get("sidebarPanel");
					if (d === undefined || d === null || typeof d.registerPanel !== "function") {
						if (hostApiRef !== undefined) detachHost();
						return;
					}
					if (hostApiRef !== undefined) {
						/* 幂等判据用 has()：不要用对象身份比较 —— 守护 ctx 下每次 get
						   都是新 Proxy。老宿主没有 has 时保守地不重绑。 */
				...
				sync();
				try { off = ctx.on("internal/service", function (name) { if (name === "sidebarPanel") sync(); }); } catch (err) { off = null; }
				...
				openInlineInput({
					...
					onCommit: (value) => {
						...
						remote().fsRename(path, target).then(() => {
							renderTree();
							refreshParentOf(path);
							/* v1.10.1: 重命名成功后的状态迁移——编辑中/预览中的
							   文件与剪贴板指向旧路径时，后续保存/粘贴会写入
							   已不存在的旧路径（保存必失败）。迁移路径并在
							   展开集合/缓存中重键旧子树；预览 detail 数据保持
							   有效（内容未变），仅路径引用更新。 */
							if (state.preview && state.preview.path === path) {
								state.preview = Object.assign({}, state.preview, { path: target, name: v });
							}
							if (state.editing && state.editing.path === path) {
								state.editing = Object.assign({}, state.editing, { path: target, name: v });
							}
							if (state.clipboard && state.clipboard.path === path) {
								state.clipboard = Object.assign({}, state.clipboard, { path: target });
								writeClipboard();
							}
							state.expanded = new Set(Array.from(state.expanded).map((k) => rekeyPath(k, path, target)).filter(Boolean));
							rekeyCache(state.cache, path, target);
							showToast("已重命名");
						}).catch((err) => {
			...
			/** v1.9.0 深/浅主题检测；v1.9.20 采用宿主权威信号——
			 *  dsh 的主题由 dsh-client-ui-theme 管理，"深色/浅色/跟随系统"
			 *  切换在 <body data-ds-dark-theme> 上（其全部深色 token 覆盖都挂
			 *  在 body[data-ds-dark-theme]{…}）。此前只检测 <html data-theme>/
			 *  class/prefers-color-scheme，手动深色时会失配 → 深色卡片用浅色配色。 */
			function themeNow() {
			...
			ctx.effect(function themeWatcher() {
				themeNow();
				/* v1.9.20: 宿主把主题挂在 <body data-ds-dark-theme> 上——同时观察
				   body（权威）与 documentElement（旧宿主 data-theme/class 兼容） */
			...
			ctx.effect(function followLoop() {
				const id = window.setInterval(() => {
					/* v2.0.0: sidebarPanel 绑定已交给 ctx.inject / 退化绑定器（它们各自
					   负责「服务出现时绑定」），这里只保留 host 模式的周期性再同步。 */
					/* v1.9.7: 自愈——settings seat 重挂载时重建 observer（MutationObserver
					   覆盖即时变化，此轮询兜底） */
					watchSettingsSeat();
					if (hostApiRef !== undefined) onHostChange();
					...
					ensureWsList().then(() => {
						...
						/* v1.10.1: 探针瞬时空快照（宿主重挂载窗口内 treeitem 未就绪）
						   不再立即回退 wsRoot()——上一轮已有稳定 DOM 路径时跳过本轮，
						   避免「切到根 → 下一轮再切回」的抖动（root 切换会清空树、
						   关闭编辑器）。连续两轮都读不到 DOM 才回退 wsRoot()。 */
						if (lastDomPath !== null) { wsProbeBusy = false; return; }
						remote().wsRoot().then((res) => {
							const candidate = res && typeof res.root === "string" && res.root !== "" ? res.root : null;
							if (typeof res.platform === "string" && res.platform !== "") state.platform = res.platform;
			...
			ctx.effect(function registerSlots() {
				...
				function HeaderEntry() {
					...
					if (hostApiRef !== undefined) return null;
			...
			/* v2.0.0: sidebarPanel 绑定 —— 规范写法优先（cordis 可选依赖），守护 ctx
			   退化为事件 + 轮询的幂等绑定器。规范见
			   dsh-ui-beautify/docs/plugin-panel-integration.md。
			   注意：`ctx.inject` 的回调**必须是箭头函数** —— cordis 用
			   `isConstructor(cb)` 区分「类插件」与「函数插件」，普通 `function` 会被
			   `new` 调用并**丢弃返回的清理函数**，于是服务消失/本插件卸载时注册会
			   泄漏在宿主里（面板残留）。 */
			ctx.effect(function sidebarPanelIntegration() {
				if (!("inject" in ctx)) return bindSidebarPanelFallback();
				try {
					ctx.inject(["sidebarPanel"], (hostCtx) => {
						...
						attachHost(d);
						/* 服务消失时由 cordis 执行这个清理函数 */
						return () => { detachHost(); };
					});
				} catch (err) {
					console.error("[dsh-file-explorer] ctx.inject unavailable, using fallback binder:", err);
					return bindSidebarPanelFallback();
				}
				/* 子纤维随本插件纤维一起销毁，无需在这里再清理 */
				return undefined;
			});
			/* v1.9.7: 初始设置状态检测（seat 可能在插件加载前就已渲染） */
			watchSettingsSeat();

			/* v1.10.1: 插件卸载（HMR/移除）时释放 body 级残留资源——预览卡片
			   （只隐藏不移除，编辑中的 selectionchange 全局监听随其脱离文档自动
			   自愈）、独立缩放 chrome 层（透明但 pointer-events:auto 的幽灵把手）、
			   toast 计时器，以及打开的浮层/菜单。 */
			ctx.effect(function unloadResourceCleanup() {
				return () => {
					try { hideToast(); } catch (err) {}
					try { closeMenu(); } catch (err) {}
					try { closeInputHost(); } catch (err) {}
					try { closeHelp(); } catch (err) {}
					if (previewCardEl !== null) { try { previewCardEl.remove(); } catch (err) {} previewCardEl = null; }
					if (previewCardChrome !== null) {
						try { previewCardChrome.dispose(); } catch (err) { try { previewCardChrome.setHidden(true); } catch (err2) {} }
						previewCardChrome = null;
					}
					if (panelChrome !== null) {
						try { panelChrome.dispose(); } catch (err) {}
						panelChrome = null;
					}
				};
			});
