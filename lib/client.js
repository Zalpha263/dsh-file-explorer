...
`;
		...
		async function apply(ctx) {
			...
			function renderPreview() {
				...
				x.className = "fexp-x";
				x.title = "关闭预览";
				x.appendChild(makeCloseIcon(10));
			...
			/* v1.7.4: DOM close icon — the ✕ text glyph rendered off-center; a
			   16-viewBox stroke SVG centers perfectly and inherits the color. */
