...
.fexp-linerow .fexp-lineno { grid-column: 1; padding-right: 10px; text-align: right; color: var(--dsw-alias-label-tertiary); user-select: none; font-size: 12px; line-height: 20px; box-sizing: border-box; overflow: hidden; }
