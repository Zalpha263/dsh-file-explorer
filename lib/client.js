...
`;
		...
		async function apply(ctx) {
			...
			const DOCK_TOP_INSET = 76; // header: 12px pad-top + 32px titleRow + 4px margin + 27px tabs — pinned to 0.1.0-rc.6 bundles; v1.9.21 复核 0.1.2-rc.1（wSkVaW_header 12+32、tabs margin-top 4px、tab 16px lh + 11px pad = 27，+1px 边框线）仍为 76
